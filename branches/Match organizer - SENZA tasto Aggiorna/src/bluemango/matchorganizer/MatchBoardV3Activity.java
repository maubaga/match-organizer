...
public class MatchBoardV3Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final int TOT = 6; //Numero totale dei giocatori
	...
	public void onBackPressed(){
		...
		this.startActivity(new Intent(this,PlayerSelectionV3Activity.class)); 
