...
public class MatchBoardV7Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final int TOT = 14; //Numero totale dei giocatori
	...
	public void onBackPressed(){
		...
		this.startActivity(new Intent(this,PlayerSelectionV7Activity.class)); 
