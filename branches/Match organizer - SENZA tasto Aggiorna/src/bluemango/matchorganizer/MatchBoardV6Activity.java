...
public class MatchBoardV6Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final int TOT = 12; //Numero totale dei giocatori
	...
	public void onBackPressed(){
		...
		this.startActivity(new Intent(this,PlayerSelectionV6Activity.class)); 
