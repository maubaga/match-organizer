...
public class MatchBoardV5Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final int TOT = 10; //Numero totale dei giocatori
		...
		for(int i = 0; i < TOT; i++){
			...
			if(str_name.equals("Buddha")){

				fun[fun_mix] = "Ma volete veramente far giocare Buddha?";
				fun_mix++;

			}

			if(str_name.equals("Presidente")){

				fun[fun_mix] = "Gioca il Bellissimo!!!";
				fun[fun_mix + 1] = "La squadra del Lacustre vince in bellezza!";
				fun_mix = fun_mix + 2;

			}
			
			if(str_name.equals("Renzo")){

				fun[fun_mix] = "Lorenz... l'è un mortorio! (cit.)";
				fun_mix++;

			}
			
			if(str_name.equals("Matteo")){

				fun[fun_mix] = "Matteo è altissimo!";
				fun_mix++;

			}
			
			if(str_name.equals("Giorio")){

				fun[fun_mix] = "Giorio ha intenzione di giocare con gli scarponi?";
				fun_mix++;

			}
			
			if(str_name.equals("Esperto")){

				fun[fun_mix] = "Non ci credo che siete riusciti a far giocare l'Esperto!";
				fun_mix++;
		...
		double rnd = Math.random() * fun_mix;
		int rand = (int) rnd;
		
		TextView comment = (TextView)findViewById(R.id.comment);
		
		comment.setText(fun[rand]);
	...
	public void onBackPressed(){
		...
		this.startActivity(new Intent(this,PlayerSelectionV5Activity.class)); 
